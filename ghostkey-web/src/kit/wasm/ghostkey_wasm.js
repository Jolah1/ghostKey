/* @ts-self-types="./ghostkey_wasm.d.ts" */
 ...
 * @param {string} descriptor_external
 * @param {string} descriptor_internal
 * @param {string} network
 * @param {number} count
 * @returns {string}
 */
export function derive_vault_addresses(descriptor_external, descriptor_internal, network, count) {
    let deferred5_0;
    let deferred5_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(descriptor_external, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(descriptor_internal, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(network, wasm.__wbindgen_export3, wasm.__wbindgen_export4);
        const len2 = WASM_VECTOR_LEN;
        wasm.derive_vault_addresses(retptr, ptr0, len0, ptr1, len1, ptr2, len2, count);
 ...
 * @returns {string}
 */
export function sign_sweep(request_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.sign_sweep(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ghostkey_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
